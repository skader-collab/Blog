...
ALLOWED_HOSTS = [h.strip() for h in os.environ.get('ALLOWED_HOSTS', '').split(',') if h.strip()] or ['cyberguardian.up.railway.app', 'localhost', '127.0.0.1']
...
if not ALLOWED_HOSTS:
    ALLOWED_HOSTS = ['cyberguardian.up.railway.app', 'localhost', '127.0.0.1']
...
CSRF_TRUSTED_ORIGINS = [
    "https://cyberguardian.up.railway.app",
    "https://*.railway.app",
]
